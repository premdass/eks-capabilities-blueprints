...
echo ""
echo "All kro RGDs have been applied automatically by Terraform."
echo ""
echo "Next steps:"
echo "  1. Deploy simple-webapp: kubectl apply -f blueprints/simple-webapp/application.yaml"
echo "  2. Check ArgoCD UI: terraform output argocd_server_url"
