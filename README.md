# EKS Capabilities Blueprints

## Motivation

[Amazon EKS Capabilities](https://docs.aws.amazon.com/eks/latest/userguide/capabilities.html) is a set of fully managed cluster features that help accelerate developer velocity and offload the complexity of building and scaling with Kubernetes. These capabilities run within EKS rather than on your worker nodes, eliminating the need to install, maintain, and scale critical platform components.

This repository includes blueprints demonstrating how to use the three EKS Capabilities:
...
Before you get started, you need to have a Kubernetes cluster with EKS Capabilities enabled. This project includes a Terraform template to create a cluster with all three capabilities (ACK, ArgoCD, kro) pre-configured.
...
* AWS Identity Center enabled in your account (required for ArgoCD capability)
...
Before you continue, enable your AWS account to launch Spot instances if you haven't already:

```sh
aws iam create-service-linked-role --aws-service-name spot.amazonaws.com || true
```

Once complete (after waiting about 15-20 minutes), configure kubectl:
...
Here's the list of blueprints:

### ACK Blueprints
* Coming soon: S3 Bucket Provisioning
* Coming soon: RDS Database Provisioning
* Coming soon: DynamoDB Table

### ArgoCD Blueprints
* [Simple Webapp](blueprints/argocd/simple-webapp/) - Deploy nginx using ArgoCD GitOps
* Coming soon: Multi-Environment Promotion

### kro Blueprints
* Coming soon: Custom WebApplication API
* Coming soon: Microservice Template

### Combined Blueprints
* Coming soon: Full-Stack App (ArgoCD + ACK + kro)
* Coming soon: Self-Service Infrastructure
...
| [AWS EKS Module](https://github.com/terraform-aws-modules/terraform-aws-eks/releases)  | v21.10.1             |
